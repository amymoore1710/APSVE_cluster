...
results_model5 <- data.frame(method = "Time-varying Testing Behavior", 
                             nstudents = nstudents, 
                             ntests = ntests, 
...
write.csv(results_model5, "/home/amoor53/APSVE_cluster/results/2021_age_5_11_TND_05_model_fit.csv")
